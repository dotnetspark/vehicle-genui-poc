...
- **Tests/CI lane (2026-06-03):** PRs #44 and #46 superseded by PR #47 (ash/tests-ci-lane). Clean single commit on top of main. Demo A: 30 pass, 2 skip (dist absent), 0 fail. Demo B Vitest: 63 pass (7 files), 0 fail. CI workflow: .github/workflows/ci.yml (Node 22 + pnpm 9). Key: used git worktree at .wt-ash-tests to isolate from concurrent agents. Integration tests skip gracefully when dist artifact absent. createQueryCache factory added for LRU eviction test isolation.
