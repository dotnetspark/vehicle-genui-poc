...
**Dependencies:** none
**Parallel:** Yes [P]
- [x] Run `git ls-files src/demo-a-mcp-apps src/demo-b-copilotkit src/etl src/shared` and bucket each file
- [x] Use `wc -l` (or PowerShell equivalent) on the resulting file list
- [x] Verification: numbers re-derivable in one shell command per demo
...
**Dependencies:** none
**Parallel:** Yes [P]
- [x] Read `src/etl/pyproject.toml`
- [x] Read `src/demo-a-mcp-apps/package.json`
- [x] Read `src/demo-b-copilotkit/runtime/package.json`
- [x] Read `src/demo-b-copilotkit/frontend/package.json`
- [x] Read root `package.json` if present
- [x] Verification: every version cited in COMPARISON.md traces back to one of these files
...
- [x] Both demos asked the same 5 questions
- [x] Notes recorded (no fabrication; if a demo crashes, that goes in the notes)
...
- [x] File created
- [x] All six section headings present in order
...
- [x] Table populated
- [x] Numbers spot-checked against `git ls-files` + `wc -l`
...
**Files:** `docs/COMPARISON.md`
**Dependencies:** 2.1
- [x] All 7 rows present
- [x] Each cell ≤ 1 sentence
...
- [x] Objective subsections complete
- [x] `[FILL IN: ...]` markers present in subjective subsections
...
**Files:** `docs/COMPARISON.md`
**Dependencies:** 2.1
- [x] Shared surfaces enumerated
- [x] Divergences enumerated
...
**Files:** `docs/COMPARISON.md`
**Dependencies:** 1.3, 2.1
- [x] Both lists present
- [x] Each scenario references a concrete capability or constraint
...
**Dependencies:** none
- [x] Section present
- [x] Steps reproducible from a clean clone
...
- [x] Branch pushed
- [x] Each file with a `mermaid` code fence visually inspected on github.com
- [x] Any non-rendering diagram fixed (likely indentation / fence language)
...
- [x] Section created with today's date
- [x] Comparison document line added
- [x] `[Unreleased]` cleared
...
**Dependencies:** none
- [x] Output captured and confirmed
...
- [x] CHANGELOG entry verified present
- [x] Roadmap item verified marked ✅
